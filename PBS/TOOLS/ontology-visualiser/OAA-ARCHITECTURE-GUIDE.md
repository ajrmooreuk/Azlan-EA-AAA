...
graph TB
    ...
    subgraph "Agent Layer"
        CLI[Claude Code CLI]
        OAA[/"OAA v6.1.0<br/>Agent System Prompt"/]
    end
...
sequenceDiagram
    ...
    participant A as OAA v6.1.0 Agent
    ...
    alt All Gates Pass
        ...
        C->>A: Process with OAA v6.1.0 system prompt
...
flowchart TD
    ...
    FAIL --> UPGRADE[Run OAA v6.1.0 Agent]
    UPGRADE --> START
...
graph TB
    subgraph "What Each Component Does"
        OAA6["OAA v6.1.0<br/>━━━━━━━━━━━━━<br/>THE AGENT<br/>• System prompt for Claude<br/>• Upgrades ontologies<br/>• Applies schema rules<br/>• Fixes compliance issues"]
