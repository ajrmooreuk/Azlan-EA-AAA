...
| 1.5 | Placeholder entries count | 3 (MCSB2, AIR, AZALZ) | |
...
| 2.5 | Foundation | AIR-ONT | `Entry-ONT-AIR-001.json` | _(placeholder — no artifact)_ | |
| 2.6 | VE-Series | VSOM-ONT | `Entry-ONT-VSOM-001.json` | `vsom-ontology-v2.1.0-oaa-v5.json` | |
...
| 5.6 | Placeholder ontologies | 3 (MCSB2, AIR, AZALZ — diamond shape) | |
| 5.7 | Failed loads | 0 | |
...
| 10.4 | `OPERATING-GUIDE.md` series table matches registry | No SA, includes KPI, EA, AIR | |
